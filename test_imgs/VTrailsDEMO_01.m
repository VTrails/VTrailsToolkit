function VTrailsDEMO_01()

addpath('../main/');

imgFileName = './test_img01.nii.gz';

%% 1) Filter the Image with the SLoGS Filterbank
scales_range = 0.4:0.1:1.0;
...
arbitraryQuantileThreshold = 0.05;
verboseFLAG = true;
...
[GeodesicMSTs,~] = VTrailsRefine3D_ConnectedGraph2VTrailsTree_MAIN( DATA , 'PruningLengthThresholdMM' , 5 );
fprintf('---------------------------------------------------------\n\n');
